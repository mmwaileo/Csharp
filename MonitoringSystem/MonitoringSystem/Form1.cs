...
namespace MonitoringSystem
{
    public partial class Form1 : Form
    {
        ...
        */
        ...
        double setting1_FW_PORT = 1.5;
        double setting1_STB = 1.5;
        double setting1_AFT_PORT = 1.5;
        double setting1_AFT_STB = 1.5;
        ...
        */
        ...
        {
            userControl3.Time = DateTime.Now.ToString("yyyy-MM-dd HH:mm");
        ...
        */
        ...
        {
            //MessageBox.Show("Picture box size changed");
        }
